...
def vgg(cfg, i, batch_norm=False):
    ...
    conv8_2 = nn.Conv2d(128, 512, kernel_size=3, padding=2, dilation=2)
    conv8_4 = nn.Conv2d(128, 512, kernel_size=3, padding=4, dilation=4)
    conv8_6 = nn.Conv2d(128, 512, kernel_size=3, padding=6, dilation=6)
    conv8_8 = nn.Conv2d(128, 512, kernel_size=3, padding=8, dilation=8)
    ...
    conv11 = nn.Conv2d(128, 1024, kernel_size=1)
