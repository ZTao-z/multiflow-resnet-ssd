...
class SSD(nn.Module):
    ...
    def __init__(self, phase, size, base, extras, head, num_classes,resnet18):
        ...
        #self.layer1_1 = resnet18_1.layer1
        #self.layer2_1 = resnet18_1.layer2
        #self.layer3_1 = resnet18_1.layer3
        #self.layer4_1 = resnet18_1.layer4
        ...
        self.vgg6 = nn.ModuleList(base[2])
        self.vgg7 = nn.ModuleList(base[3])
        self.vgg8 = nn.ModuleList(base[4])
        #self.vgg9 = nn.ModuleList(base[12])

        self.de1 = nn.ModuleList(base[5])
        self.de2 = nn.ModuleList(base[6])
        self.de3 = nn.ModuleList(base[7])
        self.de4 = nn.ModuleList(base[8])
        ...
        self.ds19_10 = nn.Sequential(
            nn.Conv2d(1024, 64, kernel_size=(1, 1), stride=2),
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True))
        self.ds10_5 = nn.Sequential(
            nn.Conv2d(512, 64, kernel_size=(1, 1), stride=2),
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True))
        ...
        self.de10_38 = nn.Sequential(
            nn.ConvTranspose2d(512, 512, kernel_size=3, stride=4, padding=1, output_padding=1),
            nn.BatchNorm2d(512),
    ...
    def forward(self, x):
        ...
        x=torch.cat((x,xx),1)
        x=self.fusion(x)
        # apply vgg up to fc79
        for k in range(29,len(self.vgg1)):
            x = self.vgg1[k](x)
...
def vgg(cfg, i, batch_norm=False):
    ...
    conv9_2_ = nn.Conv2d(512, 512, kernel_size=3, padding=1, groups=4)
    conv9_4_ = nn.Conv2d(512, 512, kernel_size=3, padding=1, groups=4)
    #conv9_6_ = nn.Conv2d(512, 512, kernel_size=3, padding=1, groups=4)
    conv9_8_ = nn.Conv2d(512, 512, kernel_size=3, padding=1, groups=4)
    ...
    conv12 = nn.Conv2d(1408, 512, kernel_size=1)
    conv13 = nn.Conv2d(512, 512, kernel_size=1)

    de3_5 = torch.nn.ConvTranspose2d(512, 512, kernel_size=3, stride=2, padding=1, output_padding=0)
    de3_5_0 = nn.BatchNorm2d(512)
    de3_5_1 = torch.nn.Conv2d(512, 512, kernel_size=(1, 1), stride=(1, 1))
    de3_5_2 = nn.BatchNorm2d(512)
    ...
    de5_10_1 = torch.nn.Conv2d(512, 512, kernel_size=(1, 1), stride=(1, 1))
    de5_10_2 = nn.BatchNorm2d(512)
    ...
    de10_19_1 = torch.nn.Conv2d(512, 1024, kernel_size=(1, 1), stride=(1, 1))
    de10_19_2 = nn.BatchNorm2d(1024)
    ...
    de19_38_1 = torch.nn.Conv2d(512, 512, kernel_size=(1, 1), stride=(1, 1))
    de19_38_2 = nn.BatchNorm2d(512)
    ...
    layer21 = [conv8_2, nn.BatchNorm2d(512), nn.ReLU(inplace=True), conv9_2, nn.BatchNorm2d(512), nn.ReLU(inplace=True),
               ...
               conv8_4, nn.BatchNorm2d(512), nn.ReLU(inplace=True), conv9_4, nn.BatchNorm2d(512), nn.ReLU(inplace=True),
               conv9_4_, nn.BatchNorm2d(512), nn.ReLU(inplace=True),
                conv10_4, nn.BatchNorm2d(128), nn.ReLU(inplace=True),
               conv8_8, nn.BatchNorm2d(512), nn.ReLU(inplace=True), conv9_8, nn.BatchNorm2d(512), nn.ReLU(inplace=True),
    ...
    layers_ori = [layers, layer21, layer25,
                  layer26, layer27, layer3, layer4, layer5, layer6]
    return layers_ori
...
def add_extras(cfg, i, batch_norm=False):
    ...
    cc8_2 = torch.nn.Conv2d(1024, 896, kernel_size=(1, 1), stride=(1, 1))
    cc8_3 = nn.BatchNorm2d(896)

    cc9 = torch.nn.Conv2d(512, 448, kernel_size=(1, 1), stride=(1, 1))
    cc9_1 = nn.BatchNorm2d(448)

    cc10 = torch.nn.Conv2d(512, 448, kernel_size=(1, 1), stride=(1, 1))
    cc10_1 = nn.BatchNorm2d(448)

    cc11 = torch.nn.Conv2d(512, 448, kernel_size=(1, 1), stride=(1, 1))
    cc11_1 = nn.BatchNorm2d(448)
    '''
