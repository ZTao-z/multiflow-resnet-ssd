...
class SSD(nn.Module):
    ...
    def __init__(self, phase, size, base, extras, head, num_classes,resnet18):
        ...
        self.de5_19 = nn.Sequential(
            nn.ConvTranspose2d(512, 512, kernel_size=3, stride=4, padding=0, output_padding=1),
            nn.BatchNorm2d(512),
    ...
    def forward(self, x):
        ...
        x19 = self.extras[28](x)

        s19 = self.extras[29](x19)
        ...
        for k in range(len(self.extras)):
            ...
            if (k == 6):
                ...
                x10 = self.extras[33](x)
                s10 = self.extras[34](x10)
                s10 = self.extras[35](s10)

                # sources.append(x10)
            elif (k == 13):
                s19_2 = self.de5_19(x)
                s19 = self.extras[30](s19)
                s19 = self.extras[31](s19)
                s19 = self.extras[32](s19)
                ...
                sources.append(s10)
                x5 = self.extras[36](x)
                s5 = self.extras[37](x5)
                s5 = self.extras[38](s5)
                ...
                s3 = self.extras[40](x3)

                s3 = self.extras[41](s3)
