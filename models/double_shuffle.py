...
class SSD(nn.Module):
    ...
    def __init__(self, phase, size, base, extras, head, num_classes,resnet18):
        ...
        self.ds19_10 = nn.Sequential(
            nn.Conv2d(1024, 256, kernel_size=(1, 1), stride=2),
            nn.BatchNorm2d(256),
            nn.ReLU(inplace=True))
        ...
        self.conpress1=nn.Conv2d(512, 256, kernel_size=1, stride=1)
        self.conpress2 = nn.Conv2d(1024, 512, kernel_size=1, stride=1)
        self.conpress3 = nn.Conv2d(1024, 256, kernel_size=1, stride=1)
        self.conpress4 = nn.Conv2d(1792, 1024, kernel_size=1, stride=1)
        self.conpress5=nn.Conv2d(1024, 512, kernel_size=1, stride=1)
        self.conpress6 = nn.Conv2d(1024, 512, kernel_size=1, stride=1)
        if phase == 'test':
        ...
        for k in range(len(self.extras)):
            ...
            if (k == 6):
                ...
                for k in range(len(self.vgg8)):
                    s38 = self.vgg8[k](s38)
                s38 = torch.cat((s38,xde38,s38_2),1)
                s38=self.conpress2(s38)
                sources.append(s38)
                ds5 = self.ds10_5(x)
                xde19 = x
                ...
                s19 = torch.cat((s19, ds19,xde19,s19_2), 1)
                s19=self.conpress4(s19)
                #s19 = s19 + s19_2
                sources.append(s19)
...
def vgg(cfg, i, batch_norm=False):
    ...
    de3_5_1 = torch.nn.Conv2d(512, 256, kernel_size=(1, 1), stride=(1, 1))
    de3_5_2 = nn.BatchNorm2d(256)
    ...
    de5_10_1 = torch.nn.Conv2d(512, 256, kernel_size=(1, 1), stride=(1, 1))
    de5_10_2 = nn.BatchNorm2d(256)
    ...
    de10_19_1 = torch.nn.Conv2d(512, 256, kernel_size=(1, 1), stride=(1, 1))
    de10_19_2 = nn.BatchNorm2d(256)
    ...
    de19_38_1 = torch.nn.Conv2d(512, 256, kernel_size=(1, 1), stride=(1, 1))
    de19_38_2 = nn.BatchNorm2d(256)
...
def add_extras(cfg, i, batch_norm=False):
    ...
    cc8_2 = torch.nn.Conv2d(1024, 1024, kernel_size=(1, 1), stride=(1, 1))
    cc8_3 = nn.BatchNorm2d(1024)

    cc9 = torch.nn.Conv2d(512, 512, kernel_size=(1, 1), stride=(1, 1))
    cc9_1 = nn.BatchNorm2d(512)

    cc10 = torch.nn.Conv2d(512, 512, kernel_size=(1, 1), stride=(1, 1))
    cc10_1 = nn.BatchNorm2d(512)

    cc11 = torch.nn.Conv2d(512, 384, kernel_size=(1, 1), stride=(1, 1))
    cc11_1 = nn.BatchNorm2d(384)
    '''
