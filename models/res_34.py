...
def multibox(vgg, extra_layers, cfg, num_classes):
    ...
    conf_layers = [
        torch.nn.Conv2d(512, 6*num_classes, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)),
        ...
        torch.nn.Conv2d(1024, 6*num_classes, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)),
        torch.nn.Conv2d(512, 6*num_classes, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)),
        torch.nn.Conv2d(512, 6*num_classes, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)),
        # ,
        torch.nn.Conv2d(512, 6*num_classes, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)),
