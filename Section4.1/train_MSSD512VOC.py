...
from data import VOCroot, COCOroot, VOC_300, VOC_512,VOC_512_3, VOC_320, VOC_300_1, VOC_300_2, COCO_300, COCO_512, \
...
parser.add_argument('-v', '--version', default='ssd',
...
def train():
    ...
    stepvalues_VOC = (80000, 90000, 100000, 110000, 120000)  # (80000,100000,120000)
    ...
    for iteration in range(start_iter, max_iter):
        ...
        if iteration<=110000 and (iteration == 0 or iteration % 10000 == 0):
            ...
            torch.save(net.state_dict(), 'weights/ssd512_2_VOC_' +
                       repr(iteration) + '.pth')
        elif (iteration>110000) and  iteration % 2000 == 0 :
            print('Saving state, iter:', iteration)
            torch.save(net.state_dict(), 'weights/ssd512_2_VOC_' +
                       repr(iteration) + '.pth')
